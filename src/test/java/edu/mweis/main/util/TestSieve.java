...
/**
 * Credit: https://stackoverflow.com/questions/10580159/sieve-of-atkin-explanation-and-java-example
 */
public class TestSieve {

    private final int limit;
    private final boolean[] sieve;
    private final int limitSqrt;

    public TestSieve(int limit) {
        this.limit = limit;
        this.sieve = new boolean[limit + 1];
        this.limitSqrt = (int) Math.sqrt((double)limit);
